...
function mediaKit(){
  const body=`<main><section class="page-hero"><div class="container"><div class="eyebrow">Publicidade</div><h1>Mídia kit</h1><p>Conecte sua marca a profissionais de engenharia, construção, arquitetura, infraestrutura, gestão e tecnologia.</p></div></section><section class="section alt"><div class="container"><div class="media-grid"><article class="article-body"><h2>Formatos disponíveis</h2><div class="media-products"><div><strong>Display</strong><span>Posições de destaque na home, editorias e matérias.</span></div><div><strong>Conteúdo patrocinado</strong><span>Projetos comerciais claramente identificados e separados do conteúdo editorial.</span></div><div><strong>Projetos especiais</strong><span>Formatos sob medida para tecnologia, produtos, eventos e serviços B2B.</span></div></div><h2>Contato comercial</h2><p><a class="source-link" href="mailto:labsvaelith@gmail.com?subject=Mídia kit VAELITH">labsvaelith@gmail.com</a></p></article><aside class="radar"><div class="tag">Audiência</div><h3>Um público profissional e especializado.</h3><p>Engenharia, construção, arquitetura, infraestrutura, gestão, tecnologia e mercado.</p></aside></div></div></section></main>`;
