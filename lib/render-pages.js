...
function about(){
  const body=`<main><section class="page-hero"><div class="container"><div class="eyebrow">Sobre</div><h1>Douglas Ornelas</h1></div></section><section class="section alt"><div class="container"><article class="article-body institutional-copy"><p>Me chamo Douglas Ornelas, engenheiro civil com MBA em Gestão de Projetos. A VAELITH nasceu da minha paixão por engenharia, construção e infraestrutura — um espaço criado para trazer as notícias mais relevantes do setor.</p></article></div></section></main>`;
