// VAELITH content pipeline — imagens externas HTTPS validadas; fallback apenas de emergência.
...
function trustedExternalImage(url=''){
  ...
  // Banco de imagem genérico não pode representar uma notícia factual.
  // Só exibimos imagem externa quando ela vem da própria fonte, de órgão/empresa oficial
  // ou de outro endereço editorial especificamente curado para aquela matéria.
