...
function trustedExternalImage(url='',credit='',caption=''){
  ...
  // Fotos genéricas de bancos de imagem não podem representar fatos noticiosos.
  // A VAELITH usa imagem da fonte/oficial quando validada; caso contrário, capa editorial neutra.
  if(/((^|\.)unsplash\.com|images\.unsplash\.com|(^|\.)pexels\.com|(^|\.)pixabay\.com)/i.test(u))return '';
  return u;
}
