...
module.exports=function renderResearch(){
  ...
  const body=`<main>
    <section class="page-hero research-hero"><div class="container"><div class="eyebrow">Pesquisa & Ciência</div><h1>Engenharia baseada em evidências.</h1></div></section>
    ...
    <section class="section alt"><div class="container"><div class="section-head"><div><div class="eyebrow">Ranking semanal</div><h2>Top 7 artigos científicos</h2></div></div><div class="research-ranked-list">${weeklyCards}</div></div></section>
    ${archiveHtml}
  </main>`;
